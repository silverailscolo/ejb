    ...
    F = (function () {
      ...
      return (
        (w.prototype.generateSettings = function (e) {
          if (
            ((this.settings = t(t({}, I), e)), this.settings.isMobile && "function" == typeof this.settings.isMobile ? this.settings.isMobile() : A())
          ) {
        ...
        (w.prototype.addHtml = function (t) {
          ...
          if ((this.galleryItems[t].subHtmlUrl ? (i = this.galleryItems[t].subHtmlUrl) : (e = this.galleryItems[t].subHtml), !i))
            if (e) {
              ...
              ("." !== s && "#" !== s) ||
                (e =
                  this.settings.subHtmlSelectorRelative && !this.settings.dynamic ? x(this.items).eq(t).find(e).first().html() : x(e).first().html());
            } else e = "";
        ...
        (w.prototype.loadContent = function (t, i) {
          ...
          if (
            (v &&
              (b = this.zoomFromOrigin && this.currentImageSize ? this.settings.startAnimationDuration + 10 : this.settings.backdropDuration + 10),
          ...
          this.settings.enableSwipe &&
            ...
            this.$inner.on("touchmove.lg", function (o) {
              n &&
                "swipe" === t.touchAction &&
                1 === o.touches.length &&
                ((i = { pageX: o.touches[0].pageX, pageY: o.touches[0].pageY }), t.touchMove(e, i, o), (s = !0));
            }),
