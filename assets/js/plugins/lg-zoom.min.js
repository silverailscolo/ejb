...
!(function (e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : "function" == typeof define && define.amd
      ? define(t)
      : ((e = "undefined" != typeof globalThis ? globalThis : e || self).lgZoom = t());
})(this, function () {
  "use strict";
  var e = function () {
      return (e =
  ...
  return (function () {
    ...
    return (
        ...
        this.$LG("body").first().hasClass("lg-from-hash") && e.detail.delay ? (o = 0) : this.$LG("body").first().removeClass("lg-from-hash"),
          (this.zoomableTimeout = setTimeout(function () {
            t.isImageSlide(t.core.index) &&
              (t.core.getSlideItem(e.detail.index).addClass("lg-zoomable"), e.detail.index === t.core.index && t.setZoomEssentials());
          }, o + 30));
      }),
      ...
      (h.prototype.zoomImage = function (e, t, o, i) {
        if (!(Math.abs(t) <= 0)) {
          ...
          if (e - t > 1) {
            ...
            (h = (d = (t < 0 ? -d : d) + this.left * (p + (t < 0 ? -1 : 1))) / p),
              (m = (f = (t < 0 ? -f : f) + this.top * (p + (t < 0 ? -1 : 1))) / p);
          } else {
            (h = d * (p = (e - t) * t)), (m = f * p);
          }
          o &&
            (c
              ...
              : e > 1 && (h < u.minX ? (h = u.minX) : h > u.maxX && (h = u.maxX)),
            g
              ? this.isBeyondPossibleTop(m, u.minY)
                ? (m = u.minY)
                : this.isBeyondPossibleBottom(m, u.maxY) && (m = u.maxY)
              : e > 1 && (m < u.minY ? (m = u.minY) : m > u.maxY && (m = u.maxY))),
            ...
            setTimeout(function () {
              if (i.src && !o.core.outer.hasClass("lg-first-slide-loading")) {
                var e = o.getCurrentImageActualSizeScale(),
                  s = o.scale;
                o.core.outer.hasClass("lg-zoomed") ? (o.scale = 1) : (o.scale = o.getScale(e)),
                  o.setPageCords(t),
                  o.beginZoom(o.scale),
          ...
          this.core.outer.on("dblclick.lg", function (t) {
            ...
            this.core.outer.on("touchstart.lg", function (o) {
              ...
              1 === o.touches.length &&
                i.hasClass("lg-image") &&
                (t
                  ? (clearTimeout(t), (t = null), o.preventDefault(), e.setActualSize(e.core.index, o))
            ...
            this.core.LGel.on(o + ".zoom " + l + ".zoom " + r + ".zoom " + g + ".zoom " + c + ".zoom", function () {
              if (e.core.lgOpened && e.isImageSlide(e.core.index) && !e.core.touchAction) {
                ...
                (e.top = 0), (e.left = 0), e.setZoomEssentials(), e.setZoomSwipeStyles(t, { x: 0, y: 0 }), (e.positionChanged = !0);
              }
            }),
      ...
      (h.prototype.touchendZoom = function (e, t, o, i, s) {
        ...
        var g = this.core.getSlideItem(this.core.index).find(".lg-img-wrap").first(),
          c = {};
        (c.x = this.left + a), (c.y = this.top + n);
        var h = this.getPossibleSwipeDragCords();
        (Math.abs(a) > 15 || Math.abs(n) > 15) &&
          (i && (this.isBeyondPossibleTop(c.y, h.minY) ? (c.y = h.minY) : this.isBeyondPossibleBottom(c.y, h.maxY) && (c.y = h.maxY)),
      ...
      (h.prototype.zoomSwipe = function () {
        ...
        this.core.$inner.on("touchstart.lg", function (s) {
          if (
            ...
            (o.$LG(s.target).hasClass("lg-item") || g.get().contains(s.target)) && 1 === s.touches.length && o.core.outer.hasClass("lg-zoomed"))
          ) {
            s.preventDefault(),
              (l = new Date()),
              (o.core.touchAction = "zoomSwipe"),
              (t = o.core.getSlideItem(o.core.index).find(".lg-img-wrap").first());
