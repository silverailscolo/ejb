  ...
  return (function () {
    ...
    return (
      ...
      (o.prototype.enableThumbDrag = function () {
        var t = this,
          e = { cords: { startX: 0, endX: 0 }, isMoved: !1, newTranslateX: 0, startTime: new Date(), endTime: new Date(), touchMoveTime: 0 },
          i = !1;
      ...
      (o.prototype.getThumbHtml = function (t, e, i) {
        ...
        s =
          h.youtube && this.settings.loadYouTubeThumbnail
            ? "//img.youtube.com/vi/" + h.youtube[1] + "/" + this.settings.youTubeThumbSize + ".jpg"
            : t;
        var n = i ? 'alt="' + i + '"' : "";
        return (
          '<div data-lg-item-id="' +
