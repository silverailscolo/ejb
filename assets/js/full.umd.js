!(function (e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : "function" == typeof define && define.amd
      ...
      : t(((e = "undefined" != typeof globalThis ? globalThis : e || self).exifr = {}));
})(this, function (e) {
  "use strict";
  var t = "undefined" != typeof self ? self : global;
  const i = "undefined" != typeof navigator,
    n = i && "undefined" == typeof HTMLImageElement,
    s = !("undefined" == typeof global || "undefined" == typeof process || !process.versions || !process.versions.node),
    r = t.Buffer,
    a = t.BigInt,
    o = !!r,
    l = (e) => e;
    ...
    const e = h("http", (e) => e),
      ...
      i = (n, { headers: s } = {}) =>
        new Promise(async (r, a) => {
          ...
          const f = { method: "GET", hostname: l, path: encodeURI(h) + c, headers: s };
          "" !== o && (f.port = Number(o));
  ...
  class I {
    ...
    set(e, t, i = I) {
      return (
        ...
        e instanceof Uint8Array || m("BufferView.set(): Invalid data argument."),
  ...
  class w extends Map {
    ...
    get(e, t) {
      return (
        this.has(e) || k(this.kind, e),
        t &&
          (e in t ||
            (function (e, t) {
              m(`Unknown ${e} '${t}'.`);
            })(this.kind, e),
          t[e].enabled || k(this.kind, e)),
        super.get(e)
      );
    }
    keyList() {
  ...
  var T = new w("file parser"),
    A = new w("segment parser"),
    D = new w("file reader");
  ...
  function x(e, t) {
    return "string" == typeof e
      ...
      : i && !n && e instanceof HTMLImageElement
        ? v(e.src, t)
        : e instanceof Uint8Array || e instanceof ArrayBuffer || e instanceof DataView
          ? new I(e)
          : i && e instanceof Blob
            ? M(e, t, "blob", U)
            : void m(O);
  ...
  const N = new Map(),
    ...
    _ = 34853,
    Y = 40965,
    $ = ["chunked", "firstChunkSize", "firstChunkSizeNode", "firstChunkSizeBrowser", "chunkSize", "chunkLimit"],
    J = ["jfif", "xmp", "icc", "iptc", "ihdr"],
    q = ["tiff", ...J],
    Q = ["ifd0", "ifd1", "exif", "gps", "interop"],
    Z = [...q, ...Q],
    ee = ["makerNote", "userComment"],
    te = ["translateKeys", "translateValues", "reviveValues", "multiSegment"],
    ie = [...te, "sanitize", "mergeOutput", "silentErrors"];
  class ne {
    get translate() {
  ...
  class se extends ne {
    ...
    constructor(e, t, i, n) {
      if (
        ...
        f(this, "pick", new Set()),
        f(this, "deps", new Set()),
        f(this, "translateKeys", !1),
        f(this, "translateValues", !1),
        f(this, "reviveValues", !1),
        (this.key = e),
        (this.enabled = t),
    ...
    translateTagSet(e, t) {
      if (this.dict) {
        let i,
          n,
          { tagKeys: s, tagValues: r } = this.dict;
    ...
    finalizeFilters() {
      !this.enabled && this.deps.size > 0
        ? ((this.enabled = !0), ue(this.pick, this.deps))
        : this.enabled && this.pick.size > 0 && ue(this.pick, this.deps);
    }
  }
  var re = {
      jfif: !1,
  ...
  class ce {
    ...
    async parse() {
      ...
      return (
        ...
        this.options.silentErrors
          ? (await this.executeParsers().catch(this.pushToErrors), t.push(...this.fileParser.errors))
    ...
    async extractThumbnail() {
      ...
      let { options: e, file: t } = this,
        i = A.get("tiff", e);
      var n;
      if ((t.tiff ? (n = { start: 0, type: "tiff" }) : t.jpeg && (n = await this.fileParser.getOrFindSegment("tiff")), void 0 === n)) return;
  ...
  class ge {
    static findPosition(e, t) {
      let i = e.getUint16(t + 2) + 2,
        ...
        s = t + n,
        r = i - n;
      return { offset: t, length: i, headerLength: n, start: s, size: r, end: s + r };
    }
    static parse(e, t = {}) {
  ...
  class ye extends pe {
    ...
    async findAppSegments(e = 0, t) {
      ...
      if (
        ...
        for (; r.size > 0 && !t && (i.canReadNextChunk || this.unfinishedMultiSegment); ) {
          ...
          if (
            ((t = e > n && !s ? !(await i.readNextChunk(e)) : !(await i.readNextChunk(n))),
    ...
    findAppSegmentsInRange(e, t) {
      ...
      let i,
        ...
        a,
        o,
        { file: l, findAll: h, wanted: u, remaining: c, options: f } = this;
      for (; e < t; e++)
        if (255 === l.getUint8(e))
          if (((i = l.getUint8(e + 1)), Se(i))) {
            if (
              ...
              s &&
                ...
                !h &&
                  (r.multiSegment && o.multiSegment
                    ? ((this.unfinishedMultiSegment = a.chunkNumber < a.chunkCount), this.unfinishedMultiSegment || c.delete(s))
                    : c.delete(s),
                  0 === c.size)))
            )
              break;
    ...
    mergeMultiSegments() {
      ...
      this.mergedAppSegments = e.map(([e, t]) => {
        ...
        if (i.handleMultiSegments) {
          return { type: e, chunk: i.handleMultiSegments(t) };
        }
        return t[0];
      });
    }
  ...
  class Pe extends ge {
    ...
    parseTag(e, t, i) {
      let { chunk: n } = this,
        ...
        a = be[s];
      if (
        (a * r <= 4 ? (e += 8) : (e = n.getUint32(e + 8)),
        (s < 1 || s > 13) && m(`Invalid TIFF value type. block: ${i.toUpperCase()}, tag: ${t.toString(16)}, type: ${s}, offset ${e}`),
        e > n.byteLength &&
          m(
            `Invalid TIFF value offset. block: ${i.toUpperCase()}, tag: ${t.toString(16)}, type: ${s}, offset ${e} is outside of chunk size ${n.byteLength}`
          ),
        1 === s)
      )
  ...
  class Ie extends Pe {
    ...
    async parseIfd0Block() {
      ...
      return 0 !== t.size
        ? ((this.exifOffset = t.get(X)),
          (this.interopOffset = t.get(Y)),
          (this.gpsOffset = t.get(_)),
          (this.xmp = t.get(j)),
          (this.iptc = t.get(W)),
          (this.icc = t.get(K)),
          this.options.sanitize && (t.delete(X), t.delete(Y), t.delete(_), t.delete(j), t.delete(W), t.delete(K)),
          t)
        : void 0;
    }
    async parseExifBlock() {
      ...
      return (
        this.interopOffset || (this.interopOffset = e.get(Y)),
        (this.makerNote = e.get(z)),
        (this.userComment = e.get(H)),
        this.options.sanitize && (e.delete(Y), e.delete(z), e.delete(H)),
        this.unpack(e, 41728),
        this.unpack(e, 41729),
        e
      );
  ...
  const Te = {
    ...
    Ae = Object.assign({}, Te, { firstChunkSize: 4e4, gps: [1, 2, 3, 4] });
  async function De(e) {
    let t = new ce(Ae);
    await t.read(e);
    let i = await t.parse();
  ...
  const Oe = Object.assign({}, Te, { tiff: !1, ifd1: !0, mergeOutput: !1 });
  async function xe(e) {
    let t = new ce(Oe);
    await t.read(e);
  ...
  async function Ue(t) {
    let i = await Re(t);
    return Object.assign({ canvas: e.rotateCanvas, css: e.rotateCss }, Le[i]);
  }
  class Fe extends I {
    constructor(...e) {
  ...
  I.prototype.getUint64 = function (e) {
    ...
    return t < 1048575
      ? (t << 32) | i
      : void 0 !== typeof a
        ? (console.warn("Using BigInt because of type 64uint but JS can only handle 53b numbers."), (a(t) << a(32)) | a(i))
        : void m("Trying to read 64b value but JS can only handle 53b numbers.");
  };
  class Ve extends pe {
    parseBoxes(e = 0) {
      let t = [];
    ...
    findExifLocIdInIinf(e) {
      ...
      for (r += 2; a--; ) {
        if (
          ...
          this.parseBoxFullHead(t),
          (i = t.start),
          t.version >= 2 && ((n = 3 === t.version ? 4 : 2), (s = this.file.getString(i + n + 2, 4)), "Exif" === s))
        )
  ...
  let We = B(G, "exif", [
    ...
    [37121, { 0: "-", 1: "Y", 2: "Cb", 3: "Cr", 4: "R", 5: "G", 6: "B" }],
    [37383, { 0: "Unknown", 1: "Average", 2: "CenterWeightedAverage", 3: "Spot", 4: "MultiSpot", 5: "Pattern", 6: "Partial", 255: "Other" }],
    [
      37384,
      {
        0: "Unknown",
    ...
    [41728, { 1: "Film Scanner", 2: "Reflection Print Scanner", 3: "Digital Camera" }],
    ...
    [41986, { 0: "Auto", 1: "Manual", 2: "Auto bracket" }],
    [41987, { 0: "Auto", 1: "Manual" }],
    [41990, { 0: "Standard", 1: "Landscape", 2: "Portrait", 3: "Night", 4: "Other" }],
    [41991, { 0: "None", 1: "Low gain up", 2: "High gain up", 3: "Low gain down", 4: "High gain down" }],
    [41996, { 0: "Unknown", 1: "Macro", 2: "Close", 3: "Distant" }],
  ...
  class et extends ge {
    static canHandle(e, t) {
      return 225 === e.getUint8(t + 1) && 1752462448 === e.getUint32(t + 4) && e.getString(t + 4, Qe.length) === Qe;
    }
    static headerLength(e, t) {
      return e.getString(t + 4, Ze.length) === Ze ? 79 : 4 + "http://ns.adobe.com/xap/1.0/".length + 1;
    }
    static findPosition(e, t) {
      let i = super.findPosition(e, t);
      return (
        (i.multiSegment = i.extended = 79 === i.headerLength),
        i.multiSegment
          ? ((i.chunkCount = e.getUint8(t + 72)), (i.chunkNumber = e.getUint8(t + 76)), 0 !== e.getUint8(t + 77) && i.chunkNumber++)
          : ((i.chunkCount = 1 / 0), (i.chunkNumber = -1)),
        i
      );
    }
  ...
  var rt = (e) => e.serialize(),
    at = (e) => (1 === e.length ? e[0] : e),
    ot = (e, t) => (t[e] ? t[e] : (t[e] = {}));
  function lt(e, t) {
    let i,
      n = [];
  ...
  const ut = ["rdf:li", "rdf:Seq", "rdf:Bag", "rdf:Alt", "rdf:Description"],
  ...
  class Tt extends pe {
    ...
    async findXmp() {
      ...
      for (let t of e) {
        t.chunk.getString(0, yt.length) === yt && this.injectSegment("xmp", t.chunk);
      }
    }
    async findIcc() {
  ...
  f(Ot, "type", "ihdr"),
    ...
    B(G, "ihdr", [
      [9, { 0: "Grayscale", 2: "RGB", 3: "Palette", 4: "Grayscale with Alpha", 6: "RGB with Alpha", DEFAULT: "Unknown" }],
  ...
  B(G, "icc", [
    ...
    [48, Lt],
    [80, Lt],
    [64, { 0: "Perceptual", 1: "Relative Colorimetric", 2: "Saturation", 3: "Absolute Colorimetric" }],
    [
      "tech",
      {
  ...
  f(Ft, "type", "iptc"),
    ...
    (e.default = ft),
    (e.extendDictionary = E),
    (e.fetchUrlAsArrayBuffer = L),
    (e.fileParsers = T),
    (e.fileReaders = D),
    (e.gps = De),
    (e.gpsOnlyOptions = Ae),
    (e.inheritables = te),
    (e.orientation = Re),
    (e.orientationOnlyOptions = Me),
    (e.otherSegments = J),
    (e.parse = fe),
    (e.readBlobAsArrayBuffer = U),
    (e.rotation = Ue),
    (e.rotations = Le),
    (e.segmentParsers = A),
    (e.segments = q),
