...
- [ ] 2026 is dedicated to overhaul the foundation of the ramses_rf back-end
...
Unfortunately, I also discovered that I could not control my ClimaRad Ventura HRU with Ramses RF (HA can read it, but you can't connect a remote to it).

But Samuel Cabrero from Spain had just released a solution at the beginning of 2025: using an Airios RF Bridge with the [pyairios](https://github.com/scabrero/pyairios) library and airios HA-integration; Search for "airios + ramses".
See:
